...
public abstract class Evaluator {
    ...
    public static final class AttributeWithValueStarting extends AttributeKeyPair {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return element.hasAttr(key) && element.attr(key).startsWith(value); // value is lower case already
        }
    ...
    public static final class AttributeWithValueEnding extends AttributeKeyPair {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return element.hasAttr(key) && element.attr(key).endsWith(value); // value is lower case
        }
    ...
    public static final class AttributeWithValueContaining extends AttributeKeyPair {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return element.hasAttr(key) && element.attr(key).contains(value); // value is lower case
        }
    ...
    public static final class ContainsText extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return (element.text().contains(searchText));
        }
    ...
    public static final class ContainsOwnText extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            return (element.ownText().contains(searchText));
        }
